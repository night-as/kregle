...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference("Equipment.count") do
      post equipment_index_url, params: { equipment: { bowling_ball_id: @equipment.bowling_ball_id, reservation_id: @equipment.reservation_id, shoe_id: @equipment.shoe_id } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { bowling_ball_id: @equipment.bowling_ball_id, reservation_id: @equipment.reservation_id, shoe_id: @equipment.shoe_id } }
